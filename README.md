...
It installs predefined agents and workflow files into `.agents/` so new projects can follow:
...
```bash
curl -fsSL https://raw.githubusercontent.com/wwnbb/agent_based/master/install.sh | bash
```
